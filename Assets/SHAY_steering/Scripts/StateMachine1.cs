...
public class StateMachine1 : MonoBehaviour {
	...
	State1 currentState; //create a new instance of State called currentState. Our state is stored in here.
	...
	public void SwitchState(State1 newState) //call this when we want to switch state and pass over the newState
	{
		if(currentState != null)
		{
